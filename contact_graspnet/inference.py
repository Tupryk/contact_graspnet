...
def inference(global_config, checkpoint_dir, input_paths, K=None, local_regions=False, skip_border_objects=False, filter_grasps=False, segmap_id=None, z_range=[0.2,1.8], forward_passes=1, verbose=0):
    """
    ...
    return pc_full, pred_grasps_cam, scores
